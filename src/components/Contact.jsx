        ...
        <div className="web3-glass-card p-6 md:p-8 bg-[#010030]/90 border-[#2e109d] rounded-2xl shadow-[0_20px_60px_rgba(1,0,48,0.8)]">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                ...
                {subjectCategories.map((cat) => {
                  ...
                  return (
                    <button
                      ...
                      className={`px-3 py-1.5 rounded-full text-xs font-mono uppercase tracking-wider transition-all cursor-pointer border ${
                        isSelected
                          ? "bg-[#F042FF] text-[#010030] font-black border-[#F042FF] shadow-[0_0_12px_rgba(240,66,255,0.4)]"
                          : "bg-[#0e0048]/80 text-zinc-300 border-[#2e109d] hover:border-[#7226FF]"
                      }`}
                    >
                      {cat}
                    </button>
            ...
            <button 
              ...
              className="y2k-button mt-4 flex items-center justify-center gap-2 cursor-pointer w-full"
              style={{ padding: "14px", fontSize: "0.95rem" }}
            >
              <Send className="w-4 h-4 shrink-0" /> {isSubmitting ? "TRANSMITTING..." : "SUBMIT INQUIRY"}
            </button>
